...
* Assertions are merely methods that throw exceptions if expected conditions are not met. The [`TestAssertions`](https://github.com/elazar/phantestic/blob/master/src/TestAssertions.php) [trait](http://php.net/manual/en/language.oop5.traits.php) can be used to pull common assertion methods into your test classes, though it's currently fairly limited. Consider [supplementary libraries](https://github.com/peridot-php/peridot/wiki/Matchers).
...
* Database seeding and assertions are not supported natively. Consider supplementary libraries like [Phactory](http://phactory.org) or [Ddeboer Data Import](https://github.com/ddeboer/data-import).
