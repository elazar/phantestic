...
* Assertions are merely methods that throw exceptions if expected conditions are not met. The [`TestAssertions`](https://github.com/elazar/phantestic/blob/master/src/TestAssertions.php) [trait](http://php.net/manual/en/language.oop5.traits.php) can be used to pull common assertion methods into your test classes.
